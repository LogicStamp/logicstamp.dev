...
export default function WhyLogicStamp() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      title: 'MCP integration: Direct AI access',
      description: 'Works seamlessly with Cursor, Claude Desktop, and Claude CLI. AI analyzes your codebase in real-time without manual context sharing.',
      stat: '7',
      statLabel: 'MCP Tools',
  ...
  return (
    <section id="why-logicstamp" className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-b from-white via-gray-50/50 to-white dark:from-gray-950 dark:via-gray-900/50 dark:to-gray-950">
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 lg:px-8">
                ...
                <div className="relative h-full rounded-2xl p-6 sm:p-8 shadow-sm transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                  <div className="relative z-10">
                    <div className="flex items-start gap-4 sm:gap-5">
                      <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br ${benefit.iconBg}`}>
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between gap-2 mb-2 sm:mb-3">
                          <div className="flex-1">
                            <h4 className="font-semibold sm:text-lg text-gray-900 dark:text-white">
                              {benefit.title}
                            </h4>
        ...
        {/* The Hook */}
        <div className={`mt-16 sm:mt-20 transition-all duration-1000 delay-600 ${
          benefitsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
