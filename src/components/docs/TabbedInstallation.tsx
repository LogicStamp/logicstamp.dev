  ...
  return (
    <div className="flex flex-col items-start">
      ...
      <div className="relative group w-full">
        ...
        <div className="relative inline-flex items-center gap-3 rounded-xl bg-white dark:bg-gray-900 px-6 sm:px-8 py-4 shadow-xl ring-1 ring-gray-300/50 dark:ring-gray-700/50 w-full">
