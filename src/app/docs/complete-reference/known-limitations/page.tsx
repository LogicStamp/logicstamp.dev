                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400 ml-4 list-disc">
                          ...
                          <li><strong>Source tool version</strong>: <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs font-mono">logicstamp-context@0.4.1</code> (current), <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs font-mono">0.4.0</code>, <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs font-mono">0.3.10</code></li>
