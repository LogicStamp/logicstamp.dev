...
export const metadata: Metadata = {
  ...
  description:
    'Detect drift between context.json files with Jest-style approval workflows and token stats.',
}

const MD_PATH = 'cli/compare.md'
const CURRENT_DOC_PATH = MD_PATH
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/cli/compare.md'

const PAGE_DESCRIPTION =
  'Compare regenerated context to disk or a git baseline, approve updates, and track token changes—similar to Jest snapshots.'
    ...
    <>
      <DocsLayout>
          ...
          <div className="relative mb-8 sm:mb-12 lg:mb-16">
            ...
            <div className="relative">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 mb-4 sm:mb-6 tracking-tight leading-[1.1]">
                <code className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600 dark:from-amber-400 dark:to-orange-400 font-mono text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
        ...
        <ReadyToGetStartedCard
          variant="green"
          description="Compare compilation modes for token tradeoffs, or return to the command index."
          primaryAction={{
