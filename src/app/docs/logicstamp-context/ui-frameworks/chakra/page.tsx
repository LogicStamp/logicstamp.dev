...
const config = UI_FRAMEWORK_DOCS.chakra
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/ui-frameworks/chakra.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching chakra doc:', error)
      ...
      <DocsLayout>
        <AnimatedSection direction="up" delay={0}>
          <div className="relative mb-8 sm:mb-12 lg:mb-16">
            <div className="absolute inset-0 bg-gradient-to-br from-teal-50 via-cyan-50/30 to-emerald-50/20 dark:from-teal-950/20 dark:via-cyan-950/10 dark:to-emerald-950/5 rounded-3xl -m-4 sm:-m-6 lg:-m-8 blur-3xl opacity-70" />
