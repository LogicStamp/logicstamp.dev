...
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/ui-frameworks/styled-components.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching styled-components doc:', error)
    return `# ${config.title}\n\nUnable to load documentation. Please check the [source on GitHub](${GITHUB_URL}).\n\nError: ${error instanceof Error ? error.message : 'Unknown'}`
  }
}

export default async function StyledComponentsPage() {
      ...
      <DocsLayout>
        <AnimatedSection direction="up" delay={0}>
          <div className="relative mb-8 sm:mb-12 lg:mb-16">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-50 via-rose-50/30 to-fuchsia-50/20 dark:from-pink-950/20 dark:via-rose-950/10 dark:to-fuchsia-950/5 rounded-3xl -m-4 sm:-m-6 lg:-m-8 blur-3xl opacity-70" />
