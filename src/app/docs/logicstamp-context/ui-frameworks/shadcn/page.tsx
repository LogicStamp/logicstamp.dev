...
const config = UI_FRAMEWORK_DOCS.shadcn
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/ui-frameworks/shadcn.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching shadcn doc:', error)
