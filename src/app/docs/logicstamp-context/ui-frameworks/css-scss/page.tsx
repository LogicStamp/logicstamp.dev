...
const config = UI_FRAMEWORK_DOCS['css-scss']
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/ui-frameworks/css-scss.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching css-scss doc:', error)
...
export default async function CssScssPage() {
      ...
      <DocsLayout>
        <AnimatedSection direction="up" delay={0}>
          <div className="relative mb-8 sm:mb-12 lg:mb-16">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 via-purple-50/30 to-violet-50/20 dark:from-indigo-950/20 dark:via-purple-950/10 dark:to-violet-950/5 rounded-3xl -m-4 sm:-m-6 lg:-m-8 blur-3xl opacity-70" />
