...
const config = FRAMEWORK_DOCS.typescript
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/frameworks/typescript.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching typescript doc:', error)
