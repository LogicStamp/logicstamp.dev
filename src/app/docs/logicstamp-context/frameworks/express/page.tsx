...
const config = FRAMEWORK_DOCS.express
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/frameworks/express.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching express doc:', error)
