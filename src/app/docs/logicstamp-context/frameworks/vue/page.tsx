...
const config = FRAMEWORK_DOCS.vue
const GITHUB_URL = 'https://github.com/LogicStamp/logicstamp-context/blob/main/docs/frameworks/vue.md'
...
async function getContent() {
  try {
    ...
    console.error('Error fetching vue doc:', error)
