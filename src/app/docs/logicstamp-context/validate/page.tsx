              ...
              <div className="relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">For CI/CD drift detection, use <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs font-mono">stamp context compare --baseline git:main</code> (v0.7.2) to compare against git refs without committing context files.</p>
                  </div>
                </div>
                <div className="mb-4">
