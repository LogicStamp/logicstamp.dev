...
**Email:** [logicstamp.dev@gmail.com](mailto:logicstamp.dev@gmail.com)
...
LogicStamp Context reads your local source files, does not execute them, never makes network requests, and only writes output files (such as `context.json` and `context_main.json`) into your project directory. For the full CLI security policy, see the [LogicStamp Context SECURITY.md on GitHub](https://github.com/LogicStamp/logicstamp-context/blob/main/SECURITY.md).

## Contact Us

If you have any questions about this Privacy & Security Policy, please contact us at [logicstamp.dev@gmail.com](mailto:logicstamp.dev@gmail.com).
